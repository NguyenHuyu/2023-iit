      ...
      {lang === 'vi' &&
        ...
        navbarVI.map((item1: any) => (
          <div className='group inline-block' key={item1.text}>
            <button className='outline-none focus:outline-none  px-1 md:px-2 py-0.5 bg-transparent rounded-lg flex items-center md:min-w-32'>
              <Link
                href={`${item1.href}`}
                      ...
                      <li className='rounded-lg relative px-0.5 py-0.5 '>
                        ...
                        >
                          {item2.itemss.map((item3: any) => (
                            ...
                            >
                              <Link href={item3.href_item}>{item3.name_item}</Link>
                            </li>
                          ))}
                        </ul>
                      </li>
